...
/**
 * Jackson1.xを使用してリクエスト/レスポンスの変換を行う{@link BodyConverter}実装クラス。
 *
 * @author Kiyohito Itoh
 */
public class Jackson1BodyConverter extends JacksonBodyConverterSupport {
